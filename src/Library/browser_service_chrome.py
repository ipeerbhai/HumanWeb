...
# Initialize Chrome browser and set it to fullscreen
# chrome_options = webdriver.ChromeOptions()

# Avoid Cloudflare by running in the browser in experimental mode
# Run chrome in debugger settings to tbe able to use the same window 
# Command for linux
